  ...
  return (
    <section className="w-full max-w-4xl mx-auto mb-40 px-4">
      ...
      <div className="relative border-l-4 border-black ml-4 md:ml-10 pl-8 pb-10">
        ...
        <div className="bg-white border-4 border-black p-6 shadow-neobrutalism hover:translate-x-1 hover:translate-y-1 hover:shadow-none transition-all duration-200 mb-12 relative overflow-hidden">
          ...
          <p className="mb-4 text-lg font-medium">
            Building robust web applications using <strong>Laravel</strong> and{" "}
            <strong>Filament</strong>, managing cloud infrastructure on{" "}
        ...
        <div className="bg-white border-4 border-black p-6 shadow-neobrutalism hover:translate-x-1 hover:translate-y-1 hover:shadow-none transition-all duration-200 relative overflow-hidden mb-12">
        ...
        <div className="bg-white border-4 border-black p-6 shadow-neobrutalism hover:translate-x-1 hover:translate-y-1 hover:shadow-none transition-all duration-200 relative overflow-hidden">
          ...
          <p className="mb-4 text-lg font-medium">
            ...
            unify product and order data across multiple platforms.
          </p>
